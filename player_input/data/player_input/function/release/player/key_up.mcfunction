...
execute unless score player.key_up player_input.listeners matches 0 run scoreboard players remove player.key_up player_input.listeners 1
execute if score player player_input.listeners matches 0 run tag @s remove player_input.listen
execute if score player.key_up player_input.listeners matches 0 run tag @s remove player_input.listen.key_up
